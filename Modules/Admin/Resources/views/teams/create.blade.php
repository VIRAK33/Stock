...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-4">
                    <h3><i class="fa fa-star"></i> Create Team</h3>
                </div>
                <div class="col-sm-8">
            ...
            <form action="{{route('team.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2" for='profile'>Prfile</label>
                            <div class="col-sm-10">
                                <textarea name="profile" id="profile" cols="30" rows="2" class="form-control"></textarea>
                            </div>
                        </div>
